...
export default function Features() {
    ...
    const featuresData = [
  {
    ...
    description: "Generates high-impact thumbnails from a single prompt.",
  },
  {
    icon: BrainIcon,
    title: "Smart Visual Intelligence",
    description: "Analyzes content, layout, and colors to maximize clicks.",
  },
  {
    icon: ZapIcon,
    title: "Instant Generation",
    description: "Create optimized thumbnails in seconds, not hours.",
  },
];
    ...
    return (
        <section className="mt-32" id="features">
            <SectionTitle
                title="Features"
                description="Design AI thumbnails that analyze content, plan layouts, and boost clicks — all powered by your prompts"
            />
