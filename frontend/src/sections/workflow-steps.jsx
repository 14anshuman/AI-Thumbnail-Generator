...
const steps = [
  {
    ...
    description:
      "Start with a simple prompt describing your video or content. Our AI understands the context and instantly plans the thumbnail design.",
  ...
  },
  {
    ...
    description:
      "Fine-tune text, colors, layout, and style. Adjust visual elements to match your brand and audience.",
    link: "https://prebuiltui.com/tailwind-templates",
  ...
  },
  {
    ...
    description:
      "Let AI generate a high-converting thumbnail in seconds. Download and use it instantly across platforms.",
    link: "https://prebuiltui.com/tailwind-templates",
...
export default function WorkflowSteps() {
    return (
        <section className="mt-32 relative" id="howitworks">
            <SectionTitle
                title="From idea to intelligent creation — quickly and effortlessly."
